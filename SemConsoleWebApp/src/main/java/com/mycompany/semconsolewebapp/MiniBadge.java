...
public class MiniBadge extends StackPane {
    ...
    MiniBadge(int channel, int kv, int mag, int wd, ArrayList<String> ops, double compression) {
    ...
    MiniBadge(SEMImage si, int channel, ArrayList<String> ops, double compression) {
